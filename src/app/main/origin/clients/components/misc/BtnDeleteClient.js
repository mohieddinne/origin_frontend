...
import { remove } from "app/services/originServices/clientService";
  ...
  const handleClick = (event) => {
    ...
    dispatch(
      MainActions.openDialog({
        fullWidth: false,
        maxWidth: "sm",
        title: t("validation.are_you_sure_you_want_to_delete_the_element", {
          context: "male",
          element: t("cApp:client"),
        }),
        content: t(
